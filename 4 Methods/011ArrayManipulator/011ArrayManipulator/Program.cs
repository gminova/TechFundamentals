/*Trifon has finally become a junior developer and has received his first task.
 ...
 since he hates manipulating arrays. They are going to pay him a lot of money though,
...
The array may be manipulated by one of the following commands
    • exchange {index} – splits the array after the given index, and exchanges the
    places of the two resulting sub-arrays. E.g. [1, 2, 3, 4, 5] -> exchange 2 -> result: [4, 5, 1, 2, 3]
...
namespace _011ArrayManipulator
{
    class Program
    {
